...
function App() {
  ...
  useEffect(() => {
    const handleHashChange = () => setActiveSection(window.location.hash.slice(1) || 'overview')
  ...
  const navItems = [['Overview', 'overview'], ['Transactions', 'transactions'], ['Budgets', 'budgets'], ['Goals', 'goals'], ['Forecast', 'forecast'], ['Debts', 'debts'], ['Reports', 'reports'], ['Accounts', 'accounts']]
  return (
    <div className={`dashboard-shell ${isDarkMode ? 'dark' : ''}`} data-page={activeSection}>
